...
approach🤔" than other programming languages and is suitable for those pursuing web development.
...
7  const o1 = {id: 1}
8  const o2 ={address: '72 Làng Tăng Phú'}
9  const o3 = {...o1, ...o2}
10 console.log(o3)
=>  Console
>(8) [1, 2, 3, 4, 5, 6, 7, 8]
>(2) {id: 1, address: "Làng Tăng Phú"}
```

...
const ProcessSection: React.FC = () => {
  ...
  return (
    <section className='mt-10 py-20'>
      ...
      <div className='mt-10 flex gap-8'>
        <div className='grid w-1/2 gap-8'>
          {steps.map((step, index) => (
            <div
              key={index}
              className='grid gap-2 rounded-lg border border-gray-200 bg-white p-6 shadow-sm'
            >
      ...
      <div className='mt-10 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 p-12 text-center text-white'>
        <h2 className='text-4xl font-bold'>We'd love to work with you</h2>
        <p className='mt-2 text-lg'>Drop us a message if you need any help</p>
        <button className='mt-4 rounded-lg bg-white px-6 py-3 font-semibold text-gray-700 shadow-md hover:bg-gray-100'>
          Let's build with us
        </button>
      </div>
    </section>

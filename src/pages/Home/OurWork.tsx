      ...
      >
        ...
        <ul className='mt-12 grid grid-cols-2 gap-6'>
          <li className='flex gap-3 overflow-clip rounded-md border border-gray-300 bg-white p-10 shadow-sm xl:pr-0'>
            <div>
              <h4 className='mb-2 text-sm font-medium uppercase text-primary-500'>
                ideate
              </h4>
              <h3 className='text-2xl font-semibold'>
                Spark and kick-off your innovation <LineBreak /> ideas
              </h3>
              <p className='mt-5'>
          ...
          <li className='flex gap-3 overflow-clip rounded-md border border-gray-300 bg-white p-10 shadow-sm xl:pr-0'>
            <div>
              ...
              <h3 className='text-2xl font-semibold'>
                Transform your dream product into <LineBreak /> reality
              </h3>
              <p className='mt-5'>
